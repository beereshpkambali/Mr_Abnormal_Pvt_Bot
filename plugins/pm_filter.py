    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Check PM, I have sent files in pm. (ನಿನ್ನ ವೈಯಕ್ತಿಕ ಖಾತೆಗೆ ಮೂವಿಯನ್ನು ಕಳುಹಿಸಿದ್ದೇನೆ, ನೋಡಿ)', show_alert=True)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('💠 GᏒԾUᎮ 💠', url='https://t.me/+h9-r4Pc2zNllMDE1'),
        ...
        buttons= [[
            InlineKeyboardButton('♥️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 ♥️', url='https://t.me/+i5bo7Qx_dRMwZTg1')
            ],[
